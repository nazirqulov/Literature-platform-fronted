...
const GuestDashboard: React.FC = () => {
    return (
        <div className="space-y-16 pb-20">
            {/* Hero Section */}
            <section id="home" className="relative pt-20 pb-32 text-center overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto px-4 space-y-8 animate-fade-in-up">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                        ...
                        <Link to="/login" className="px-8 py-3 text-lg font-medium text-[#2B2B2B] glass hover:bg-white transition-all rounded-lg">
                            Kutubxonani ko'rish
                        </Link>
                    </div>
                </div>
            ...
            <section id="books" className="max-w-7xl mx-auto px-4 space-y-8">
                <div className="flex items-end justify-between">
                    ...
                    <Link to="/login" className="text-[#6B4F3A] hover:text-[#5A4030] font-medium flex items-center gap-1 group">
            ...
            <section id="authors" className="max-w-7xl mx-auto px-4 space-y-8">
                <div className="flex items-end justify-between">
                    <div className="space-y-2">
                        <h2 className="text-3xl font-bold text-[#2B2B2B]">Mualliflar</h2>
