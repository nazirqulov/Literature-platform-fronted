...
const schema = yup.object().shape({
    usernameOrEmail: yup.string().required('Username yoki Email kiritilishi shart'),
    ...
    return (
        <div className="space-y-6">
            <div className="text-center">
                ...
                <p className="text-slate-400 mt-2 text-sm italic">O'zbek adabiyoti xazinasiga kirish</p>
            </div>

            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                <div>
                    <label className="block text-sm font-medium text-slate-300 mb-1">Foydalanuvchi nomi yoki Email</label>
